...
@Module({
  imports: [
    TypeOrmModule.forFeature([Role, UserEntity, UserGeneralEntity, SessionEntity, GroupEntity, OtorisasiMenuEntity, Permission, RolePermission, UserRole]),
    LoggerFileModule,
    AuthModule,
    UserModule
  ],
  controllers: [RolesController],
  providers: [RolesService, UserGeneralService],
})
